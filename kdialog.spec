...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/kdialog-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/kdialog-24.12.0.tar.xz.sig
...
%setup -q -n kdialog-24.12.0
cd %{_builddir}/kdialog-24.12.0
pushd ..
cp -a kdialog-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735258126
mkdir -p clr-build
pushd clr-build
