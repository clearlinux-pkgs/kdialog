...
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/kdialog-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/kdialog-23.08.5.tar.xz.sig
...
%prep
%setup -q -n kdialog-23.08.5
cd %{_builddir}/kdialog-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708415518
mkdir -p clr-build
pushd clr-build
