...
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/kdialog-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/kdialog-24.02.2.tar.xz.sig
...
%setup -q -n kdialog-24.02.2
cd %{_builddir}/kdialog-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712889821
mkdir -p clr-build
pushd clr-build
