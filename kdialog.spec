...
Version  : 19.08.3
Release  : 15
URL      : https://download.kde.org/stable/applications/19.08.3/src/kdialog-19.08.3.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.3/src/kdialog-19.08.3.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.3/src/kdialog-19.08.3.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573167299
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdialog-19.08.3/COPYING %{buildroot}/usr/share/package-licenses/kdialog/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kdialog-19.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/kdialog/e1d31e42d2a477d6def889000aa8ffc251f2354c
pushd clr-build
%make_install
popd
%find_lang kdialog
