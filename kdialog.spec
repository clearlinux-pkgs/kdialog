...
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/kdialog-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/kdialog-22.08.1.tar.xz.sig
...
%prep
%setup -q -n kdialog-22.08.1
cd %{_builddir}/kdialog-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662771666
mkdir -p clr-build
pushd clr-build
