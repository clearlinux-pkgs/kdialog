...
Version  : 24.08.1
Release  : 75
URL      : https://download.kde.org/stable/release-service/24.08.1/src/kdialog-24.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kdialog-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kdialog-24.08.1.tar.xz.sig
...
%setup -q -n kdialog-24.08.1
cd %{_builddir}/kdialog-24.08.1
pushd ..
cp -a kdialog-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726196265
mkdir -p clr-build
pushd clr-build
