...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kdialog-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kdialog-24.05.1.tar.xz.sig
...
%setup -q -n kdialog-24.05.1
cd %{_builddir}/kdialog-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718416719
mkdir -p clr-build
pushd clr-build
