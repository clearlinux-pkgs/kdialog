...
Source0  : https://download.kde.org/stable/release-service/21.04.0/src/kdialog-21.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.04.0/src/kdialog-21.04.0.tar.xz.sig
...
%prep
%setup -q -n kdialog-21.04.0
cd %{_builddir}/kdialog-21.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619212814
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdialog-21.04.0/COPYING %{buildroot}/usr/share/package-licenses/kdialog/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kdialog-21.04.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kdialog/e1d31e42d2a477d6def889000aa8ffc251f2354c
pushd clr-build
%make_install
popd
%find_lang kdialog
