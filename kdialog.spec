...
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/kdialog-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/kdialog-23.08.4.tar.xz.sig
...
%prep
%setup -q -n kdialog-23.08.4
cd %{_builddir}/kdialog-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702982010
mkdir -p clr-build
pushd clr-build
