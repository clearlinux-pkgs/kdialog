...
Version  : 20.04.1
Release  : 21
URL      : https://download.kde.org/stable/release-service/20.04.1/src/kdialog-20.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.04.1/src/kdialog-20.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.1/src/kdialog-20.04.1.tar.xz.sig
...
%prep
%setup -q -n kdialog-20.04.1
cd %{_builddir}/kdialog-20.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589850966
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdialog-20.04.1/COPYING %{buildroot}/usr/share/package-licenses/kdialog/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kdialog-20.04.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kdialog/e1d31e42d2a477d6def889000aa8ffc251f2354c
pushd clr-build
%make_install
popd
%find_lang kdialog
