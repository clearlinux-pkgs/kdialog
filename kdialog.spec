...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kdialog-21.12.0.tar.xz
...
%prep
%setup -q -n kdialog-21.12.0
cd %{_builddir}/kdialog-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639636589
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdialog-21.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kdialog/e1d31e42d2a477d6def889000aa8ffc251f2354c
cp %{_builddir}/kdialog-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdialog/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
%find_lang kdialog
